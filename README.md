...
- Run: `docker run -p 9090:9090 registry.prod.auction.local:5000/homes-ms-retail:DEV`
...
- Run: `docker run -p 9090:9090 registry.prod.auction.local:5000/homes-ms-retail`
